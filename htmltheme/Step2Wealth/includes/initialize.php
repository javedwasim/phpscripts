...
include_once (LIB_PATH.DS."products.php");
include_once (LIB_PATH.DS."Database.php");
include_once (LIB_PATH.DS."steptowealthDb.php");
include_once (LIB_PATH.DS."models".DS."SlideShows.php");
include_once (LIB_PATH.DS."models".DS."Slides.php");
global $currentUrl;
