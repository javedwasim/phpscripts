...
if (isset($_GET['template_id'])) {
    ...
    //$accountCreated = createSubAccount('rine_t@ip6.pp.ua');
...
//$sso_link = "http://1m.1mobil-e.com/free-instant-mobile-website?url=".$sso_link."#img_container";
//return SSO link
return $sso_link;
}
...
function displayTemplates() {
    ...
    foreach($output as $template) {
        ...
        echo '<td><a href="http://1mobil-e.com/api/whitelabel.php?template_id='. $template->template_id .'" target="_blank"><img src="' . $template->thumbnail_url. '"></a>' . '</td>';
