<?php
	...
	$ac = new ActiveCampaign("https://javed693.api-us1.com", "3ba2467edc9e1ec44cfd8bd99ea0ee7fbd92a915a0572629eec164d608701045ac08ae3e");
	...
	// API method.
	  ...
	  if ($listids)
		$request .= "?filters[listid]= 5";
	  else
	  $request .= "?ids=1";
	  // Make request.
	  $request .= "&full=0&sort=id&sort_direction=ASC&per_page=500";
	  $response = $ac->api($request);
