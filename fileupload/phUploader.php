...
$full_url="http://localhost/phpcodegenier/uploads/";
		...
		For($i=0; $i <= $file_uploads-1; $i++) {
			...
			If($_FILES['file']['name'][$i]) {
				...
				If($random_name){
					...
					$file_name[$i]=cln_file_name($_FILES['file']['name'][$i])."".time();
				} Else {
...
<form action="<?php $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data" name="phuploader">
